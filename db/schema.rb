...
ActiveRecord::Schema.define(:version => 20120828000626) do
  ...
  create_table "featureds", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "featured_order",              :default => 1, :null => false
  end
  ...
  create_table "products", :force => true do |t|
    ...
    t.decimal  "discount_pj",             :precision => 10, :scale => 2, :default => 0.0
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.integer  "area_phone"
    t.integer  "area_cellphone"
  end
